...
//
// In Digital Stadium, this class is for the status bar.
//
...
#define kLPScrollingTickerLabelItem_Title_Font          [UIFont boldSystemFontOfSize:16.0f]
#define kLPScrollingTickerLabelItem_Description_Font    [UIFont systemFontOfSize:16.0f]
